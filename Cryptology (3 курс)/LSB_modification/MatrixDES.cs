...
{
    public static class MatrixDES
    {
        public static BitArray FirstPermutation(BitArray getBlock)
        {
        ...
        public static BitArray EndPermutation(BitArray getBlock)
        {
            BitArray output = new BitArray(getBlock.Length);
            for (int i = 0; i < getBlock.Length; i++)
            {
                output[IPblockEnd[i] - 1] = getBlock[i];
            }
            return output;
        ...
        public static int[] matrixExpansion = {
                      32, 1, 2, 3, 4, 5,
                      4, 5, 6, 7, 8, 9,
                      8, 9, 10, 11, 12, 13,
                      12, 13, 14, 15, 16, 17,
        ...
        public static int[] straightPermutation = {
                      16, 7, 20, 21, 29, 12, 28,
                      17, 1, 15, 23, 26, 5, 18,
                      31, 10, 2, 8, 24, 14, 32,
                      27, 3, 9, 19, 13, 30, 6,
